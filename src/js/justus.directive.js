...
justusApp.directive('isbnDirective', ['JustusService', function(Justus) {
  return {
    require: 'ngModel',
...
justusApp.directive('issnDirective', ['JustusService', function(Justus) {
  return {
    require: 'ngModel',
    link: function(scope, element, attr, mCtrl) {
...
justusApp.directive('orcidDirective', ['JustusService', function(Justus) {
  return {
    require: 'ngModel',
    link: function(scope, element, attr, mCtrl) {
